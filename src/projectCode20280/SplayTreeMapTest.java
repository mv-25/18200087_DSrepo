...
import java.util.Scanner;
 ...
 public class SplayTreeMapTest
 {
    ...
    {            
        ...
        System.out.println("Splay Tree Map Test\n");          
        char ch;
        /**  Perform tree operations  **/
        do    
        {
            System.out.println("\nSplay Tree Map Test Operations\n");
            ...
            switch (choice) {
                ...
                case 4 -> System.out.println("Nodes = " + spt.countNodes());
                case 5 -> System.out.println("Empty status = " + spt.isEmpty());
                case 6 -> {
                    System.out.println("\nTree Cleared");
                    spt.clear();
                }
