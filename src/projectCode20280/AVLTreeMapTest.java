...
{  
    ...
    private int getHeight(NodeA node )
    {  
    ...
    private NodeA insertElement(int element, NodeA node)
    {  
        //check whether the node is null or not  
        if (node == null)  
            node = new NodeA(element);
    ...
    private NodeA rotateWithLeftChild(NodeA node2)
    {  
        NodeA node1 = node2.leftChild;
    ...
    private NodeA rotateWithRightChild(NodeA node1)
    {  
        NodeA node2 = node1.rightChild;
    ...
    private NodeA doubleWithLeftChild(NodeA node3)
    {  
    ...
    private NodeA doubleWithRightChild(NodeA node1)
    {  
    ...
    private int getTotalNumberOfNodes(NodeA head)
    {  
        if (head == null)  
            return 0;  
        else  
    ...
    private boolean searchElement(NodeA head, int element)
    {  
        boolean check = false;  
    ...
    private void inorderTraversal(NodeA head)
    {  
        if (head != null)  
        {  
    ...
    private void preorderTraversal(NodeA head)
    {  
        if (head != null)  
        {  
            System.out.print(head.element+" ");  
    ...
    private void postorderTraversal(NodeA head)
    {  
        if (head != null)  
        {  
...
{  
    ...
    {              
        ...
        {  
            ...
            {  
                case 1 :   
                    System.out.println("Please enter an element to insert in AVL Tree Map");  
                ...
                case 5 :   
                    ...
                    break;  
                case 6 :   
                    System.out.println("\nDisplay AVL Tree Map in Post order");  
                    obj.postorderTraversal();  
                    break;  
                case 7 :   
                    System.out.println("\nDisplay AVL Tree Map in Pre order");  
                    obj.preorderTraversal();  
                    break;  
                case 8 :   
                    System.out.println("\nDisplay AVL Tree Map in In order");  
